...
//			System.out.println(characterability.getAbilityScores().getStraight());
		...
		public void testAbilityAccordingToItemWornHelmetI()
		{
			...
			AbilityScoresModel ability_int=new AbilityScoresModel();
			...
			System.out.println(ability_int.getStraight());
			
					
			Assert.assertEquals(ability_int.getIntelligence(),intelligence);
		...
		public void testAbilityAccordingToItemWornHelmetW()
		{
			...
			Assert.assertEquals(ability_int.getWisdom(),wisdom);
		...
		//	System.out.println(abilityint.getStraight());
			...
			Assert.assertEquals(ability_int.getStraight(),strength);
		...
		//	System.out.println(abilityint.getStraight());
			...
			Assert.assertEquals(ability_int.getConstitution(),constitution);
		...
		public void testAbilityAccordingToItemWornRingCh()
		{
			...
			item_character.getAbilityScores().setCharisma(10);
		...
		//	System.out.println(abilityint.getStraight());
			...
			Assert.assertEquals(ability_int.getCharisma(),charisma);
		...
		public void testAbilityAccordingToItemWornBeltS()
		{
			...
			item_character.setItems(items_cha);
			item_character.getAbilityScores().setstrength(10);
		...
		public void testAbilityAccordingToItemWornBeltC()
		{
			...
			item_character.setItems(items_cha);
			item_character.getAbilityScores().setConstitution(10);
		...
		public void testAbilityAccordingToItemWornBoot()
		{
			...
			item_character.setItems(items_cha);
			item_character.getAbilityScores().setDexterity(10);
		...
		//	System.out.println(abilityint.getStraight());
			...
			Assert.assertEquals(ability_int.getDexterity(),dexterity);
