...
public class Explorer {
	...
	/**
	 * The Director assumes that all Fighters have the same characteristics and
	 * each part is built by calling the same method though what these specific
	 * methods do may be different.
	 */
