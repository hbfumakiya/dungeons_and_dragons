...
/**
 * This class is to create a map for items and their possible set of abilities
...
public class ItemMap {
	...
	/**
	 * What this method does is that it stores the items and values like
	 * abilities scores etc that can be used as a reference inside ItemWindow
	 * class for selecting the items and the corresponding value that is
	 * supposable to be increased by the user.
	 * 
	 * @return the hashmap of items as key and their corresponding abilities as
	 *         values
	 */
