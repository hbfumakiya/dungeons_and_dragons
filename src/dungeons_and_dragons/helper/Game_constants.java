...
public class Game_constants {
	...
	public final static DefaultComboBoxModel HELMET_MODEL = new DefaultComboBoxModel(
			new String[] { Game_constants.INTELLIGENCE, Game_constants.WISDOM, Game_constants.ARMOR_CLASS });
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static final DefaultComboBoxModel ARMOR_MODEL = new DefaultComboBoxModel(
			new String[] { Game_constants.ARMOR_CLASS });
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static final DefaultComboBoxModel SHIELD_MODEL = new DefaultComboBoxModel(
			new String[] { Game_constants.ARMOR_CLASS });
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static final DefaultComboBoxModel RING_MODEL = new DefaultComboBoxModel(
			new String[] { Game_constants.STRENGTH, Game_constants.WISDOM, Game_constants.ARMOR_CLASS,
					Game_constants.CONSTITUTION, Game_constants.CHARISMA });
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static final DefaultComboBoxModel BELT_MODEL = new DefaultComboBoxModel(
			new String[] { Game_constants.STRENGTH, Game_constants.CONSTITUTION });
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static final DefaultComboBoxModel BOOTS_MODEL = new DefaultComboBoxModel(
			new String[] { Game_constants.DEXTERITY, Game_constants.WISDOM, Game_constants.ARMOR_CLASS });
